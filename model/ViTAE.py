...
class ViTAE(nn.Module):
    def __init__(self, in_channels=1,out_channels=1, img_size=128,patch_size=4,dim=512,depth=8,num_heads=8,mlp_dim=2048):
        super(ViTAE, self).__init__()

        self.encoder = ViTEncoder(img_size,patch_size,dim,depth,num_heads,mlp_dim,in_channels)
        self.decoder = ViTDecoder(img_size,patch_size,dim,depth,num_heads,mlp_dim,out_channels)
